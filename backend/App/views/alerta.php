...
if (ProPayPal) {
    ...
    define("PayPalBaseUrl", "https://registro.dualdisorderswaddmexico2022.com/Login/");
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0" id="navigation">
                    ...
                    <ul class="navbar-nav d-lg-block d-none">
                        <li class="nav-item">
                            <a href="/Login/" class="btn btn-sm  bg-gradient-info  btn-round mb-0 me-1" onclick="smoothToPricing('pricing-soft-ui')">INICIAR SESÍÓN</a>
                        </li>
                    </ul>
                </div>
            </div>
        </nav <div class="page-header min-vh-75">
        <div class="container">
            <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-12 col-lg-12 m-auto">
                                                <div id="card_one" class="card multisteps-form__panel p-3 border-radius-xl bg-white js-active" id="card_one" data-animation="FadeIn">
                                                    <center>
                                                        <h4 class="font-weight-bolder mb-0">¡GRACIAS POR TU INSCRIPCIÓN!</h4>
                                                    </center>
                                                    ...
                                                    <div class="multisteps-form__content">
                                                        ...
                                                        <p>
                                                            ...
                                                            Bienvenido a <strong>XXXI CONGRESO ANUAL DE LA SOCIEDAD MEXICANA DE NEUROLOGÍA PEDIÁTRICA</strong> Usted ha sido registrado, para participar en este evento que se estará realizando del 16 al 21 de mayo de 2022.

                                                            Con la sigueinte cuenta de correo electrónico que nos proporciono, usted podrá ingresar a la plataforma el día del evento:
                                                        </p>
                                                        ...
                                                        <div class="button-row d-flex mt-4">
                                                            <a href="<?php echo ($regreso) ? $regreso : '/' ?>" class="btn btn-sm btn bg-gradient-info ms-auto mb-0 js-btn-next" type="button" title="Next">VOLVER AL SITIO WEB</a>
                                                        </div>
                                                    </div>
